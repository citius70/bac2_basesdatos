...
| Plato              | Precio (€) | Tiempo Prep. (min) | Popularidad | Cocinero      | Edad | Alta/Baja | Categoría gastronómica |
|--------------------|------------|--------------------|-------------|---------------|------|-----------|-----------------------|
| Pizza Margherita   | 5,00       | 25                 | 4,7         | Luigi         | 42   | Alta      | Italiana              |
| Sushi Maki         | 7,00       | 20                 | 4,5         | Akira         | 35   | Alta      | Japonesa              |
| Paella             | 9,00       | 40                 | 4,8         | Carmen        | 47   | Alta      | Mediterránea          |
...
| Tortilla Española  | 4,00       | 20                 | 4,4         | Carmen        | 47   | Alta      | Mediterránea          |
...
| Moussaka           | 7,50       | 50                 | 4,2         | Carmen        | 47   | Alta      | Griega                |
| Falafel            | 4,00       | 20                 | 4,4         | Samir         | 38   | Alta      | Árabe                 |
| Kimchi             | 5,50       | 50                 | 3,9         | Pierre        | 55   | Alta      | Coreana               |
| Ceviche            | 8,00       | 15                 | 4,4         | Carmen        | 47   | Alta      | Peruana               |
...
Se separa la información en tres tablas: Plato, Cocinero, CategoríaGastronómica.
...
erDiagram
direction LR
    COCINERO ||--|{ PLATO : elabora
    CATEGORIA_GASTRONOMICA ||--|{ PLATO : pertenece
...
|---------------------------|---------------|-------------------------------------|------------------------------------|
| **COCINERO**              | id_cocinero   | nombre, edad, activo                |                                    |
| **CATEGORIA_GASTRONOMICA**| id_categoria  | nombre (Italiana, Japonesa...)      |                                    |
